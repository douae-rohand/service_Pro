...
class CommentaireSeeder extends Seeder
{
    ...
    public function run(): void
    {
        ...
        DB::table('commentaire')->insert([
            ...
            [
                'intervention_id' => 1,
                'commentaire' => 'Client très sympathique et accueillant. Le jardin était bien entretenu, ce qui a facilité mon travail. Très bonne communication. Je m\'excuse for le léger retard dû à un imprévu de circulation.',
